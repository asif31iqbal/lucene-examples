...
public class HighlighterDemo {
	...
	public static void searchIndexWithQueryParser(String searchString) throws IOException, ParseException {
		...
		//System.out.println("Type of query: " + query.getClass().getSimpleName());
		 ...
		 displayHits(query, hits);
	}
        //////////////////////////////////////////////////////////////////////// 
	public static void displayHits(Query query, ScoreDoc[] hits) throws CorruptIndexException, IOException {
		...
		while (it.hasNext()) {
			...
			System.out.println("Hit: " + path); 
                        ...
                        System.out.println("Explain/Highlighting : " + expl.toString()); 
                        System.out.println("Explain/Highlighting (HTML) : " + expl.toHtml()); 
		}
	}
        ////////////////////////////////////////////////////////////////////////
