...
public class LuceneWildcardQueryDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		utils.MyUtils.delete(new File (INDEX_DIRECTORY));
                createIndex();
                searchIndexWithWildcardQuery(FIELD_CONTENTS, args[0]);
	...
	public static void searchIndexWithWildcardQuery(String whichField, String searchString) throws IOException, ParseException {
